...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand   navbar-light bg-success ">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="https://co-waltd.mdarthur.com/caja_operaciones" class="nav-link">Inicio</a>
                </li>
            </ul>


            <!-- ///////////////////////Derecho menu  navbar links/////////////////////////////////////////////// -->
            <ul class="navbar-nav ml-auto">

                <li class="nav-item show">
                    <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="true"> <i
                            class="fas fa-cogs"></i>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right show"
                        ...
                        <a class="dropdown-item" data-toggle="modal" data-target="#exampleModal">
                            ...
                            <i class="fas fa-building mr-2"></i> Compañía
        ...
        <!-- /.navbar -->
        <!--    Marica borra todo esto  empieza modal de Pruebasss -->
        <!-- Modal -->
        <!-- Modal -->
