...
<div class="container ">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-dark center ">  <h2 class=" text-center text-white">Inicio de Sesión</h2> </div>
...
<!--/vh-100 h-100 h-100  {{ __('Login') }} -->
  ...
  <form method="POST" action="{{ route('in_log') }}">
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-12 col-form-label ">{{ __('E-Mail Address') }}</label>
