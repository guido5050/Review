    ...
    return (
        <>
            <div className="flex flex-col h-screen justify-between">
                <div className="flex  items-center px-4 py-2 mt-0 bg bg-gray-900">
                    <Link
                ...
                {emailHtml && (
                    <div className="border-8 p-10 mx-auto w-full md:w-1/2 lg:w-1/3 overflow-y-auto max-h-[500px]">
                        {parse(emailHtml)}
                    </div>
                )}
                <div className="flex py-5 justify-end items-center pb-5 bg-gray-900 mt-auto">
                    <Link
                        onClick={(e) => {
                            e.preventDefault();
